...
static const PumdVendorSpec pumd_vendor_specs[PUMD_VENDOR_SPEC_COUNT] = {
    {"javascript", "58404d8cf191d69f2674a8fd507bd5776f46cb11", "MIT",
     tree_sitter_javascript, pumd_query_javascript, pumd_query_javascript_len,
     NULL, 0, 0},
    {"jsx", "58404d8cf191d69f2674a8fd507bd5776f46cb11", "MIT",
     tree_sitter_javascript, pumd_query_javascript, pumd_query_javascript_len,
     pumd_query_javascript_jsx, pumd_query_javascript_jsx_len, 0},
    {"typescript", "75b3874edb2dc714fb1fd77a32013d0f8699989f", "MIT",
     tree_sitter_typescript, pumd_query_javascript, pumd_query_javascript_len,
     pumd_query_typescript, pumd_query_typescript_len, 0},
    {"tsx", "75b3874edb2dc714fb1fd77a32013d0f8699989f", "MIT",
     tree_sitter_tsx, pumd_query_javascript, pumd_query_javascript_len,
     pumd_query_tsx, pumd_query_tsx_len, 0},
    {"shell", "a06c2e4415e9bc0346c6b86d401879ffb44058f7", "MIT",
     tree_sitter_bash, pumd_query_bash, pumd_query_bash_len, NULL, 0, 0},
    {"powershell", "e7bd348c49fdfd5c853a146a670965ba516a6239", "MIT",
     tree_sitter_powershell, pumd_query_powershell, pumd_query_powershell_len,
     NULL, 0, 0},
    {"json", "001c28d7a29832b06b0e831ec77845553c89b56d", "MIT",
     tree_sitter_json, pumd_query_json, pumd_query_json_len, NULL, 0, 0},
    {"yaml", "a1c4812a73ec5e089de8e441fdea3a921e8d5079", "MIT",
     tree_sitter_yaml, pumd_query_yaml, pumd_query_yaml_len, NULL, 0, 0},
    {"toml", "64b56832c2cffe41758f28e05c756a3a98d16f41", "MIT",
     tree_sitter_toml, pumd_query_toml, pumd_query_toml_len, NULL, 0, 0},
    {"html", "73a3947324f6efddf9e17c0ea58d454843590cc0", "MIT",
     tree_sitter_html, pumd_query_html, pumd_query_html_len, NULL, 0, 1},
    {"css", "dda5cfc5722c429eaba1c910ca32c2c0c5bb1a3f", "MIT",
     tree_sitter_css, pumd_query_css, pumd_query_css_len, NULL, 0, 0},
    {"xml", "5000ae8f22d11fbe93939b05c1e37cf21117162d", "MIT",
     tree_sitter_xml, pumd_query_xml, pumd_query_xml_len, NULL, 0, 0},
    {"sql", "c2e1e08db1ea20dc23bdb8d228a81a8756e9c450", "MIT",
     tree_sitter_sql, pumd_query_sql, pumd_query_sql_len, NULL, 0, 0},
    {"markdown", "a0a00f817d02412bd92c54d316f164d827b57b5c", "MIT",
     tree_sitter_markdown, pumd_query_markdown, pumd_query_markdown_len, NULL,
     0, 0},
    {"http", "db8b4398de90b6d0b6c780aba96aaa2cd8e9202c", "MIT",
     tree_sitter_http, pumd_query_http, pumd_query_http_len, NULL, 0, 0},
    {"protobuf", "42d82fa18f8afe59b5fc0b16c207ee4f84cb185f", "MIT",
     tree_sitter_proto, pumd_query_protobuf, pumd_query_protobuf_len, NULL, 0,
     0},
};
